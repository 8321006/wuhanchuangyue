								...
								<table class="table-striped table">
									...
									<tbody>
										<c:forEach items="${paper }" var="item">
											<tr>
												<td>
													<input type="checkbox" value="${item.paperId }">
												</td>
												<td>${item.paperId }</td>
												<td><a href="paper/preview/${item.paperId}.action" target="_blank" title="预览" class="td-paper-name">${item.paperName }</a></td>
												<td><span class="td-paper-duration">${item.answerCostTime}</span>分钟</td>
												<td>${item.creator }</td>
												<td>
															<a href="admin/exampaper-edit/${item.paperId}.action">修改内容</a>

			...
			<div class="row">
					<div class="col-xs-3">
						<ul class="nav default-sidenav">
							<li class="active">
								<a href="question/question-list.action"> <i class="fa fa-list-ul"></i> 试卷管理 </a>
							</li>
							<li>
								<a href="question/question-add.action"> <i class="fa fa-pencil-square-o"></i> 添加试卷 </a>
							</li>
							<li>
								<a href="paper/paper-import.action"> <i class="fa fa-cloud-upload"></i> 导入试卷 </a>
							</li>
						</ul>
					</div>
					<div class="col-xs-9">
						<div class="page-header">
							<h1><i class="fa fa-cloud-upload"></i> 导入试卷 </h1>
						</div>
						<div class="page-content row">
							<form id="from-question-import"action="${pageContext.request.contextPath}/paper/paper-import.action" method="post">
							...
							<div class="form-line template-download">
								...
								<a href="resources/template/paper.xls" style="color:rgb(22,22,22);text-decoration: underline;">点击下载</a>
							</div>

var calendar = {
    ...
    clear: function () {
        ...
        calendar.config.input =null;
        calendar.config.message =null;
    ...
    show: function () {
        ...
        input.setAttribute("id", "displayInput");
        input.style.display="none";
        var body=document.getElementsByTagName("body")[0];
        body.appendChild(input);
        calendar.config.id=input;
        calendar.config.input=input;
    ...
    init: function (s) {
        ...
        _c.push("</div>");
        _c.push("<div class='calendar_boy' >");
        ...
        var _boy = document.getElementById("user_calendar");
        ...
        calendar.config.message=message;
        message.setAttribute("id","message");
        message.setAttribute("class", "message");
        var box=document.createElement("div");
        box.setAttribute("id","box");
        box.setAttribute("class", "box");
        box.setAttribute('style', "left:" + calLeft + "px;top:" + calTop + "px;z-index:" + calendar.config.zIndex + ";");
        box.appendChild(_div);
        box.appendChild(message);
        _boy.appendChild(box);
        ...
        $("#_tdCal tr:gt(0) td[date!='']").click(function () {
            ...
            $(this).css({ "color": "#fff", "background-color": "#fe8e8e" });
    ...
    _ok:function(obj){
    	if (calendar.config.ok != null) {
            eval(calendar.config.ok(calendar.config.input));
            calendar._showMessage(obj);
        }
    },
    _showMessage:function(obj){
    	var message=calendar.config.message;
    	message.innerHTML=calendar.config.messageData;

...
public class JavaDemoHttp {
	public static void main(String[] args) throws UnsupportedEncodingException{
		...
		String strReg = "101100-WEB-HUAX-845867";   //注册号（由华兴软通提供）
        String strPwd = "JKQMHKQK";                 //密码（由华兴软通提供）
        String strSourceAdd = "";                   //子通道号，可为空（预留参数一般为空）
        String strTim = HttpSend.paraTo16("2012-2-16 12:00:00"); //定时发送时间
        String strPhone = "18672332052";//手机号码，多个手机号用半角逗号分开，最多1000个
        String strContent = HttpSend.paraTo16("尊敬的用户:欢迎使用易启学。您的短信验证码为:123456,请及时填写，如非本人操作，请不要理会。【易启学】");       //短信内容
        
        String strUname = HttpSend.paraTo16("18672332052"); //用户名，不可为空
        String strMobile = "18672332052";            //手机号，不可为空
